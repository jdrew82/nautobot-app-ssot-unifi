...
So for example, our plugin is named `nautobot-ssot-unifi`, the command would most likely be `docker logs nautobot_ssot_unifi_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
