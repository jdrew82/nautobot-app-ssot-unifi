...
from nautobot_ssot_unifi import __version__ as project_version
...
class TestVersion(unittest.TestCase):
    ...
    def test_version(self):
        ...
        parent_path = os.path.dirname(  # pylint: disable=no-member
            os.path.dirname(os.path.dirname(os.path.realpath(__file__)))  # pylint: disable=no-member
        )
        poetry_version = toml.load(os.path.join(parent_path, "pyproject.toml"))["tool"][  # pylint: disable=no-member
            "poetry"
        ]["version"]
...
class TestDocsPackaging(unittest.TestCase):
    ...
    def test_version(self):
        ...
        poetry_path = os.path.join(parent_path, "pyproject.toml")  # pylint: disable=no-member
